  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form className="flex flex-col gap-4">
        ...
        <input type="text" placeholder='Username' id='username' className='bg-slate-100 p-3 rounded-lg' defaultValue={currentUser.username}/>
        <input type="email" placeholder='Email' id='email' className='bg-slate-100 p-3 rounded-lg' defaultValue={currentUser.email}/>
