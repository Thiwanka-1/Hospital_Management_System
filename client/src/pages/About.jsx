      ...
      <section className="container mx-auto py-20 px-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            <img src="/images/ide.png" alt="IDE" className="mx-auto mb-4" />
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            <img src="/images/courses.png" alt="Courses" className="mx-auto mb-4" />
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            <img src="/images/quiz.png" alt="Quizzes" className="mx-auto mb-4" />
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            <img src="/images/problems.png" alt="Coding Problems" className="mx-auto mb-4" />
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            <img src="/images/notes.png" alt="Quick Notes" className="mx-auto mb-4" />
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            <img src="/images/community.png" alt="Community Support" className="mx-auto mb-4" />
      ...
      <section className="bg-gray-200 py-20">
        <div className="container mx-auto px-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {/* Team Member 1 */}
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              <img src="/images/team1.png" alt="Team Member 1" className="w-32 h-32 rounded-full mx-auto mb-4" />
            ...
            {/* Team Member 2 */}
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              <img src="/images/team2.png" alt="Team Member 2" className="w-32 h-32 rounded-full mx-auto mb-4" />
            ...
            {/* Team Member 3 */}
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              <img src="/images/team3.png" alt="Team Member 3" className="w-32 h-32 rounded-full mx-auto mb-4" />
